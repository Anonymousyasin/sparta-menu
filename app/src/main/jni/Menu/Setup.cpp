...
void Init(JNIEnv *env, jobject thiz, jobject ctx, jobject title, jobject bottomTitle){
    Menu::setText(env, title, OBFUSCATE("<b>-=[ SPARTA MENU ]=-</b>"));
    Menu::setText(env, bottomTitle, OBFUSCATE("<b>- Built with Sparta IDE -</b>"));

    // Set Colored Text
    // setText(env, title, OBFUSCATE("<b><p style=\"color:green\">Sparta Menu</p></b>"));

    Menu::showToast(env,ctx,OBFUSCATE("Sparta Menu loaded"),ToastLength::LENGTH_LONG);
